...
<Window
    ...
    FontFamily="Segoe UI">
    <Border Background="#0A120A" BorderBrush="#3D5A3D" BorderThickness="1" CornerRadius="8" Padding="24">
        <Grid>
            <Grid.RowDefinitions>
            ...
            <StackPanel Grid.Row="0">
                <TextBlock Text="Zombob SS toolkit" FontSize="20" FontWeight="Bold" Foreground="#2ECC71" Margin="0,0,0,12"/>
                <TextBlock TextWrapping="Wrap" Foreground="#EAFFEA" FontSize="13" Margin="0,0,0,12"
                ...
                <TextBlock TextWrapping="Wrap" Foreground="#EAFFEA" FontSize="13" Margin="0,0,0,16"
                ...
                <TextBlock TextWrapping="Wrap" Foreground="#EAFFEA" FontSize="13" FontWeight="SemiBold"
            ...
            <Grid Grid.Row="1" VerticalAlignment="Bottom">
                ...
                <Button x:Name="CancelBtn" Grid.Column="0" Content="Cancel" Height="40"
                        Background="Transparent" Foreground="#EAFFEA" BorderBrush="#3D5A3D" BorderThickness="1"
                        Cursor="Hand" FontSize="13"/>
                <Button x:Name="AcceptBtn" Grid.Column="2" Content="Accept &amp; Continue" Height="40"
                        Background="#162216" Foreground="#2ECC71" BorderBrush="#2ECC71" BorderThickness="1"
